...
# -*- coding: utf-8 -*-
"""
@file: xml_et_cdatasection.py
@author: tangcc
@time: 2019-01-08 17:16:03
@description:
"""
...
def CDATASection(text=None):
    """CDATA element factory.
    ...
    for elem in elem.iter():
        ...
        if isinstance(tag, QName):
            ...
            if tag not in qnames:
                add_qname(tag)
        elif tag is not None and tag is not Comment and tag is not PI and tag is not CDATASection:
